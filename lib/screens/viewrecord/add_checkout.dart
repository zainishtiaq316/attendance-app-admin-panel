...
class AddCheckOut extends StatefulWidget {
  UserModel user = UserModel();
   final auth = FirebaseAuth.instance;
  String? uid;
  String? userToken;
   AddCheckOut({super.key, required this.user});

  @override
  State<AddCheckOut> createState() => _markattState();
}

class _markattState extends State<AddCheckOut> {
final nameController = TextEditingController();
 ...
 Future<bool> checkAttendanceCheckOut() async {
...
@override
  Widget build(BuildContext context) {
    return FutureBuilder<bool>(
        ...
        future: checkAttendanceCheckOut(),
