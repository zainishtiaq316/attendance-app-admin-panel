...
class AddLeaves extends StatefulWidget {
  ...
  String? uid;
  String? userToken;
   AddLeaves({super.key, required this.user});

  @override
  State<AddLeaves> createState() => _markattState();
}

class _markattState extends State<AddLeaves> {
final nameController = TextEditingController();
 ...
 Future<bool> checkAttendanceLeaves() async {
